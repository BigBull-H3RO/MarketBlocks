...
/**
 * Viewer-spezifischer Laufzeitstatus eines Server-Shop-Angebots.
 */
public record ServerShopOfferViewState(
        int maxPurchasable,
    ...
    public ServerShopOfferViewState {
    ...
    public static ServerShopOfferViewState empty() {
        return new ServerShopOfferViewState(0, Optional.empty(), Optional.empty(), Optional.empty(), 1.0d);
    }
    ...
    public static ServerShopOfferViewState fromTag(CompoundTag tag) {
        if (tag == null) {
            return empty();
        }
