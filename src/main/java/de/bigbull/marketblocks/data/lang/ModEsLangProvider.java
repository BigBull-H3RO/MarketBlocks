...
public class ModEsLangProvider extends LanguageProvider {
        ...
        protected void addTranslations() {
                ...
                // === GUI - Settings ===
                add("gui.marketblocks.access.edit_access_list", "LISTA ACCESO");
                add("gui.marketblocks.access.edit_access_list.tooltip", "Administrar lista de acceso de clientes");
                add("gui.marketblocks.access.edit_owners", "PROPIETARIOS");
                add("gui.marketblocks.access.edit_owners.tooltip", "Administrar copropietarios de la tienda");
                add("gui.marketblocks.access.group.management", "GESTIÓN");
                add("gui.marketblocks.access.group.players", "LISTA DE JUGADORES");
                add("gui.marketblocks.access.group.whitelist", "JUGADORES WHITELIST");
                add("gui.marketblocks.access.group.blacklist", "JUGADORES BLACKLIST");
                add("gui.marketblocks.access.counter", "%d / %d");
                add("gui.marketblocks.access.filter_whitelist", "MODO: WHITELIST");
                ...
                add("gui.marketblocks.io.master_toggle.tooltip", "Activar / desactivar sistema E/S y tolvas");
                add("gui.marketblocks.io.group.sides", "CARAS DEL BLOQUE");
                add("gui.marketblocks.io.group.automation", "AUTOMATIZACIÓN & REDSTONE");
                add("gui.marketblocks.io.allow_io", "Permitir I/O");
                add("gui.marketblocks.io.allow_io.tooltip", "Interacción con tolvas y tuberías");
                add("gui.marketblocks.io.auto_io", "Transferencia de cofres (Auto-E/S):");
                add("gui.marketblocks.io.auto_io.tooltip", "Transferencia automática con cofres adyacentes");
                add("gui.marketblocks.io.redstone_control.ignored", "Redstone: Ignorado");
                add("gui.marketblocks.io.redstone_control.require_no_signal", "Redstone: Sin señal");
                add("gui.marketblocks.io.redstone_control.require_signal", "Redstone: Señal requerida");
                add("gui.marketblocks.io.redstone_control.tooltip", "Condición de redstone para E/S");
                add("gui.marketblocks.legend.input", "ENTRADA");
                add("gui.marketblocks.legend.output", "SALIDA");
                add("gui.marketblocks.legend.disabled", "DESACTIVADO");
                ...
                add("gui.marketblocks.visuals.bobbing.tooltip", "Suave movimiento de balanceo");
                add("gui.marketblocks.visuals.chaos_rotation", "ROTACIÓN CAOS:");
                add("gui.marketblocks.visuals.chaos_rotation.tooltip", "Variación aleatoria de rotación");
                add("gui.marketblocks.visuals.count", "Cantidad de objetos");
                add("gui.marketblocks.visuals.count.tooltip", "Cantidad de objetos visibles (1–64)");
                add("gui.marketblocks.visuals.count_short", "CANT.:");
                add("gui.marketblocks.visuals.display", "VISUALIZACIÓN:");
                add("gui.marketblocks.visuals.group.item_arrangement", "DISPOSICIÓN DE OBJETOS");
                add("gui.marketblocks.visuals.group.visuals_transformations", "EFECTOS Y TRANSFORMACIONES");
                add("gui.marketblocks.visuals.dynamic_fill_level", "LLENADO DIN.:");
                add("gui.marketblocks.visuals.dynamic_fill_level.tooltip", "Ajustar exhibición al inventario");
                ...
                add("gui.marketblocks.visuals.height.tooltip", "Altura flotante sobre el bloque");
                add("gui.marketblocks.visuals.layout_mode", "Modo de dise\u00f1o");
                add("gui.marketblocks.visuals.layout_mode.tooltip", "Disposición: Apilado o Suelto");
                ...
                add("gui.marketblocks.visuals.npc_enabled.tooltip", "Mostrar/ocultar PNJ decorativo");
                add("gui.marketblocks.visuals.npc_name", "Nombre del NPC");
                add("gui.marketblocks.visuals.npc_name.tooltip", "Nombre sobre el PNJ");
                ...
                add("gui.marketblocks.visuals.offer_item_fullbright.tooltip", "Hace que el objeto brille en la oscuridad");
                add("gui.marketblocks.visuals.offer_item_visible", "Objeto de oferta visible");
                add("gui.marketblocks.visuals.offer_item_visible.tooltip", "Mostrar/ocultar exhibición de objetos");
                add("gui.marketblocks.visuals.payment_sounds", "SONIDOS DE PAGO:");
                add("gui.marketblocks.visuals.payment_sounds.tooltip", "Sonido de moneda al pagar");
                add("gui.marketblocks.visuals.purchase_particles", "PART\u00cdCULAS DE COMPRA:");
                add("gui.marketblocks.visuals.purchase_particles.tooltip", "Partículas de esmeralda al comprar");
                add("gui.marketblocks.visuals.purchase_sounds", "SONIDOS DE COMPRA:");
                add("gui.marketblocks.visuals.purchase_sounds.tooltip", "Sonido de compra de aldeano");
                add("gui.marketblocks.visuals.npc_short", "NPC:");
                add("gui.marketblocks.visuals.npc_name_label", "NOMBRE:");
                add("gui.marketblocks.visuals.rotation", "ROTACIÓN:");
                add("gui.marketblocks.visuals.rotation.tooltip", "Rotación base de los objetos");
                ...
                add("gui.marketblocks.visuals.scale.tooltip", "Tamaño de los objetos");
                add("gui.marketblocks.visuals.spacing_xz", "ESPACIADO X/Z:");
                add("gui.marketblocks.visuals.spacing_xz.tooltip", "Desplazamiento horizontal");
                add("gui.marketblocks.visuals.spacing_y", "ESPACIADO Y:");
                add("gui.marketblocks.visuals.spacing_y.tooltip", "Espaciado vertical de objetos");
                add("gui.marketblocks.visuals.speed", "VELOCIDAD:");
                add("gui.marketblocks.visuals.speed.tooltip", "Velocidad de rotación");
                ...
                add("gui.marketblocks.visuals.use_player_skin.tooltip", "Modelo de jugador en vez de aldeano");
                add("gui.marketblocks.visuals.group.npc_appearance", "APARIENCIA");
                add("gui.marketblocks.visuals.group.npc_feedback", "EFECTOS Y RESPUESTA");
                ...
                add("gui.marketblocks.visuals.player_skin_name.tooltip", "Aspecto del jugador especificado");
                add("gui.marketblocks.visuals.profession", "Profesi\u00f3n");
                add("gui.marketblocks.visuals.profession.tooltip", "Vestimenta y profesión del PNJ");
                ...
                // === GUI - Notifications ===
                add("gui.marketblocks.notifications.group.trade_activity", "ACTIVIDAD COMERCIAL");
                add("gui.marketblocks.notifications.group.status_warnings", "ALERTAS DE ESTADO");
                add("gui.marketblocks.notifications.co_owners", "NOTIFICAR A COPROPIETARIOS:");
                add("gui.marketblocks.notifications.co_owners.tooltip", "Enviar notificaciones a copropietarios");
                add("gui.marketblocks.notifications.out_of_stock", "ALERTA DE AGOTADO:");
                add("gui.marketblocks.notifications.out_of_stock.tooltip", "Aviso cuando la tienda esté vacía");
                add("gui.marketblocks.notifications.output_full", "ALERTA DE SALIDA LLENA:");
                add("gui.marketblocks.notifications.output_full.tooltip", "Aviso cuando la salida esté llena");
                add("gui.marketblocks.notifications.purchase", "NOTIFICACIONES DE COMPRA:");
                add("gui.marketblocks.notifications.purchase.tooltip", "Notificación en el chat al comprar");
                ...
                add("gui.marketblocks.admin_shop.button.active", "MODO ADMIN: ACTIVO");
                add("gui.marketblocks.admin_shop.button.inactive", "MODO ADMIN: DESACTIVADO");
                add("gui.marketblocks.admin_shop.button.tooltip", "Alterna el modo Tienda Admin. En modo Admin, la tienda tiene stock infinito y no requiere cofre.");
                add("gui.marketblocks.admin_shop.badge", "★ TIENDA ADMIN");
                add("gui.marketblocks.admin_shop.badge.tooltip", "Tienda Admin activa: Stock infinito. No se requieren ni consumen art\u00edculos del inventario del cofre.");
                ...
                add("gui.marketblocks.category.tooltip", "Categoría en el directorio");
                ...
                add("gui.marketblocks.emit_redstone", "SE\u00d1AL DE REDSTONE:");
                add("gui.marketblocks.emit_redstone.tooltip", "Pulso de redstone breve al comprar");
                add("gui.marketblocks.general.status_label", "ESTADO:");
                add("gui.marketblocks.general.status.active", "ACTIVO");
                add("gui.marketblocks.general.status.paused", "PAUSA");
                add("gui.marketblocks.general.status.active.tooltip", "Tienda abierta (Clic para pausar)");
                add("gui.marketblocks.general.status.paused.tooltip", "Tienda pausada (Clic para abrir)");
                ...
                add("gui.marketblocks.purchase_sound", "SONIDO DE COMPRA XP:");
                add("gui.marketblocks.purchase_sound.tooltip", "Efecto de sonido al comprar");
                add("gui.marketblocks.purchase_xp_sound", "SONIDO DE COMPRA XP:");
                add("gui.marketblocks.purchase_xp_sound.tooltip", "Efecto de sonido al comprar");
                add("gui.marketblocks.save", "Guardar");
                add("gui.marketblocks.save.active.tooltip", "Guardar cambios");
                add("gui.marketblocks.save.inactive.tooltip", "Sin cambios sin guardar");
                ...
                add("gui.marketblocks.shop_name.tooltip", "Nombre visible de la tienda");
                ...
                add("gui.marketblocks.side.left.letter", "I");
