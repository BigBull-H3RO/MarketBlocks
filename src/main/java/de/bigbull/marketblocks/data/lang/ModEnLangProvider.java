...
public class ModEnLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("gui.marketblocks.visuals.offer_item.type.trade_stand", "Trade Stand Offer Item");
        ...
        add("gui.marketblocks.visuals.offer_item.trade_stand.rotation_speed.tooltip", "Rotation speed of the floating offer item (0 = off)");
        add("gui.marketblocks.visuals.offer_item.trade_stand.height_offset", "Height Offset");
        add("gui.marketblocks.visuals.offer_item.trade_stand.height_offset.tooltip", "Vertical offset of the floating offer item");
        add("gui.marketblocks.visuals.offer_item.market_crate.count", "Display Count");
        add("gui.marketblocks.visuals.offer_item.market_crate.count.tooltip", "How many offer item copies are rendered in the crate");
        add("gui.marketblocks.visuals.offer_item.market_crate.height_offset", "Height Offset");
        add("gui.marketblocks.visuals.offer_item.market_crate.height_offset.tooltip", "Vertical offset of rendered offer items in the crate");
        add("gui.marketblocks.visuals.offer_item.market_crate.rotation_speed", "Rotation Speed");
        add("gui.marketblocks.visuals.offer_item.market_crate.rotation_speed.tooltip", "Rotation speed of rendered offer items (0 = off)");
        add("gui.marketblocks.visuals.offer_item.market_crate.random_placement", "Random Placement");
        add("gui.marketblocks.visuals.offer_item.market_crate.random_placement.tooltip", "Scatter rendered offer items with random offsets");
        add("gui.marketblocks.visuals.offer_item.market_crate.stable_random", "Stable Random");
        add("gui.marketblocks.visuals.offer_item.market_crate.stable_random.tooltip", "Keep random placement stable instead of changing every tick");
        add("gui.marketblocks.visuals.offer_item.reset", "Reset");
        add("gui.marketblocks.visuals.offer_item.reset.tooltip", "Reset visual offer settings of this shop type to defaults");
