...
public class ModFrLangProvider extends LanguageProvider {
        ...
        protected void addTranslations() {
                ...
                add("gui.marketblocks.purchase_sound", "Son à l'achat");
                add("gui.marketblocks.purchase_sound.tooltip", "Joue un son lorsqu'un joueur achète quelque chose");
                add("gui.marketblocks.purchase_xp_sound", "Son à l'achat");
