...
public class ModDeLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("gui.marketblocks.visuals.offer_item.type.trade_stand", "TradeStand Angebots-Item");
        ...
        add("gui.marketblocks.visuals.offer_item.trade_stand.rotation_speed.tooltip", "Drehgeschwindigkeit des schwebenden Offer-Items (0 = aus)");
        add("gui.marketblocks.visuals.offer_item.trade_stand.height_offset", "Höhen-Offset");
        add("gui.marketblocks.visuals.offer_item.trade_stand.height_offset.tooltip", "Vertikaler Offset des schwebenden Offer-Items");
        add("gui.marketblocks.visuals.offer_item.market_crate.count", "Anzahl");
        add("gui.marketblocks.visuals.offer_item.market_crate.count.tooltip", "Wie viele Offer-Item-Kopien in der Kiste dargestellt werden");
        add("gui.marketblocks.visuals.offer_item.market_crate.height_offset", "Höhen-Offset");
        add("gui.marketblocks.visuals.offer_item.market_crate.height_offset.tooltip", "Vertikaler Offset der Offer-Items in der Kiste");
        add("gui.marketblocks.visuals.offer_item.market_crate.rotation_speed", "Drehgeschwindigkeit");
        add("gui.marketblocks.visuals.offer_item.market_crate.rotation_speed.tooltip", "Drehgeschwindigkeit der dargestellten Offer-Items (0 = aus)");
        add("gui.marketblocks.visuals.offer_item.market_crate.random_placement", "Zufällige Platzierung");
        add("gui.marketblocks.visuals.offer_item.market_crate.random_placement.tooltip", "Verteilt Offer-Items mit zufälligen Offsets");
        add("gui.marketblocks.visuals.offer_item.market_crate.stable_random", "Stabile Zufälligkeit");
        add("gui.marketblocks.visuals.offer_item.market_crate.stable_random.tooltip", "Behält die Zufallsplatzierung stabil statt pro Tick neu");
        add("gui.marketblocks.visuals.offer_item.reset", "Reset");
        add("gui.marketblocks.visuals.offer_item.reset.tooltip", "Setzt Visual-Offer-Einstellungen dieses Shop-Typs auf Standard zurück");
