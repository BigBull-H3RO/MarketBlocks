#!/bin/bash
cat << 'INNER_EOF' > shop_settings.patch
--- src/main/java/de/bigbull/marketblocks/feature/visual/npc/ShopVisualSettings.java
+++ src/main/java/de/bigbull/marketblocks/feature/visual/npc/ShopVisualSettings.java
@@ -1,6 +1,9 @@
...
INNER_EOF
patch src/main/java/de/bigbull/marketblocks/feature/visual/npc/ShopVisualSettings.java < shop_settings.patch
