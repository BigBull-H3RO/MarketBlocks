#!/bin/bash
cat << 'INNER_EOF' > sections.patch
--- src/main/java/de/bigbull/marketblocks/feature/singleoffer/client/screen/SingleOfferSettingsSections.java
+++ src/main/java/de/bigbull/marketblocks/feature/singleoffer/client/screen/SingleOfferSettingsSections.java
@@ -12,6 +12,8 @@
...
INNER_EOF
patch src/main/java/de/bigbull/marketblocks/feature/singleoffer/client/screen/SingleOfferSettingsSections.java < sections.patch
