...
import de.bigbull.marketblocks.platform.inventory.CommonSlotItemHandler;
...
public class SingleOfferShopMenu extends AbstractSingleOfferShopMenu implements ShopMenu {
    ...
    private final ICommonItemHandler paymentHandler;
    private final ICommonItemHandler offerHandler;
    private final ICommonItemHandler inputHandler;
    private final ICommonItemHandler outputHandler;
    ...
    private abstract class BaseSlot extends CommonSlotItemHandler {
        private final ShopTab tab;

        BaseSlot(ICommonItemHandler handler, int slot, int x, int y, ShopTab tab) {
        ...
        public void setChanged() {
            super.setChanged();
            this.getItemHandler().setStackInSlot(this.getSlotIndex(), this.getItem());
        }
    }

    private class GatedSlot extends BaseSlot {
        GatedSlot(ICommonItemHandler handler, int slot, int x, int y, ShopTab tab) {
    ...
    private class OwnerGatedSlot extends BaseSlot {
        OwnerGatedSlot(ICommonItemHandler handler, int slot, int x, int y, ShopTab tab) {
            super(handler, slot, x, y, tab);
        }
    ...
    private class OfferSlot extends BaseSlot {
        OfferSlot(ICommonItemHandler handler, int slot, int x, int y) {
    ...
    private class OutputGatedSlot extends BaseSlot {
        OutputGatedSlot(ICommonItemHandler handler, int slot, int x, int y, ShopTab tab) {
            super(handler, slot, x, y, tab);
        }
