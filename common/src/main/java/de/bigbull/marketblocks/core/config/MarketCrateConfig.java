...
public class MarketCrateConfig {
    ...
    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_EMIT_REDSTONE;
    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_PURCHASE_SOUND;
    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_IS_CLOSED;

    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_VILLAGER_NPC_ENABLED;
    public static final TomlConfigValue.EnumValue<VillagerVisualProfession> MARKETCRATE_DEFAULT_VILLAGER_PROFESSION;
    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_PURCHASE_PARTICLES;
    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_PURCHASE_SOUNDS;
    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_PAYMENT_SLOT_SOUNDS;
    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_USE_PLAYER_SKIN;

    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_ITEM_VISIBLE;
    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_ITEM_FULLBRIGHT;
    public static final TomlConfigValue.DoubleValue MARKETCRATE_DEFAULT_ITEM_SCALE;
    public static final TomlConfigValue.IntValue MARKETCRATE_DEFAULT_ITEM_COUNT;
    public static final TomlConfigValue.EnumValue<CrateLayoutMode> MARKETCRATE_DEFAULT_ITEM_LAYOUT_MODE;
    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_ITEM_DYNAMIC_FILL;
    public static final TomlConfigValue.DoubleValue MARKETCRATE_DEFAULT_ITEM_ROTATION;
    public static final TomlConfigValue.DoubleValue MARKETCRATE_DEFAULT_ITEM_SPACING_XZ;
    public static final TomlConfigValue.DoubleValue MARKETCRATE_DEFAULT_ITEM_SPACING_Y;
    public static final TomlConfigValue.DoubleValue MARKETCRATE_DEFAULT_ITEM_CHAOS_ROTATION;

    public static final TomlConfigValue.EnumValue<IoRedstoneControl> MARKETCRATE_DEFAULT_REDSTONE_CONTROL;
    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_ALLOW_IO;
    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_AUTO_IO;

    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_NOTIFY_PURCHASE;
    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_NOTIFY_OUT_OF_STOCK;
    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_NOTIFY_OUTPUT_FULL;
    public static final TomlConfigValue.BooleanValue MARKETCRATE_DEFAULT_NOTIFY_CO_OWNERS;
