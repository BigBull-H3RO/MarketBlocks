...
public class TradeStandConfig {
    ...
    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_EMIT_REDSTONE;
    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_PURCHASE_SOUND;
    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_IS_CLOSED;

    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_VILLAGER_NPC_ENABLED;
    public static final TomlConfigValue.EnumValue<VillagerVisualProfession> TRADESTAND_DEFAULT_VILLAGER_PROFESSION;
    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_PURCHASE_PARTICLES;
    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_PURCHASE_SOUNDS;
    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_PAYMENT_SLOT_SOUNDS;
    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_USE_PLAYER_SKIN;

    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_ITEM_VISIBLE;
    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_ITEM_FULLBRIGHT;
    public static final TomlConfigValue.DoubleValue TRADESTAND_DEFAULT_ITEM_SCALE;
    public static final TomlConfigValue.DoubleValue TRADESTAND_DEFAULT_ITEM_SPEED;
    public static final TomlConfigValue.DoubleValue TRADESTAND_DEFAULT_ITEM_HEIGHT_OFFSET;
    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_ITEM_BOBBING;

    public static final TomlConfigValue.EnumValue<IoRedstoneControl> TRADESTAND_DEFAULT_REDSTONE_CONTROL;
    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_ALLOW_IO;
    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_AUTO_IO;

    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_NOTIFY_PURCHASE;
    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_NOTIFY_OUT_OF_STOCK;
    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_NOTIFY_OUTPUT_FULL;
    public static final TomlConfigValue.BooleanValue TRADESTAND_DEFAULT_NOTIFY_CO_OWNERS;
