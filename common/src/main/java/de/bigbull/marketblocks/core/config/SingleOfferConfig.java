...
public class SingleOfferConfig {
    ...
    public static final TomlConfigValue.IntValue CHEST_IO_INTERVAL;
    public static final TomlConfigValue.BooleanValue ENABLE_OUTPUT_WARNING;
    public static final TomlConfigValue.IntValue OUTPUT_WARNING_PERCENT;
    public static final TomlConfigValue.IntValue NOTIFICATION_COOLDOWN;
    ...
    // --- Tab Visibility ---
    public static final TomlConfigValue.BooleanValue SHOP_TAB_VILLAGER_ENABLED;
    public static final TomlConfigValue.BooleanValue SHOP_TAB_VISUALS_ENABLED;
    public static final TomlConfigValue.BooleanValue SHOP_TAB_NOTIFICATIONS_ENABLED;
